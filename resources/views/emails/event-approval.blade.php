    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="success-box">
                ...
                <p>Nous sommes ravis de vous informer que votre inscription à l'<strong>événement de lancement</strong> du livre "Le Maroc Social 2030" a été <strong>confirmée</strong>.</p>
            </div>
            
            <div class="content">
                <p>Votre participation à cet événement important est précieuse pour nous. Nous avons hâte de vous accueillir et de partager avec vous cette étape importante de notre projet.</p>
                ...
                <p>Vous recevrez prochainement un e-mail avec tous les détails pratiques de l'événement (lieu, date, horaire, programme, etc.).</p>
